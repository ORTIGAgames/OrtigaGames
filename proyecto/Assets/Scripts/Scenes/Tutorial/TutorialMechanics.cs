...
public class TutorialMechanics : MonoBehaviour
{
    ...
    string[] welcome = { 
        ...
        "See on the top, a combat menu appears, with the stats of the ally and the possible actions, attack and ability. You can see what does the abity clicking on the arrow next to the icon in the combat menu. ",
        "When one of your allies attack it will damage the enemy based on the enemies’ defense and your allies’ attack stat. Let's attack the enemy for the moment.",
