    ...
    public override void OnMouseDown()
    {
        ...
        else if (game.allyturn && turn > 0)
        {
            ...
            if (!game.CombatH.gameObject.active)
            {
                ...
                game.CharacterActivate(Face, NameIcon, Damage.ToString(), Defense.ToString(), MaxHealth, this.GetComponent<Abilities>().Name, this.GetComponent<Abilities>().description);
